...
<div class="navbar-nav ms-auto py-0">
  ...
  <a  class="nav-item nav-link active"><Link to="/cpadmin">Change Password</Link></a>
  <a  class="nav-item nav-link active"><Link to="/epadmin">Edit Profile</Link></a>


  <a  class="nav-item nav-link active"><Link to="/addproject">Add Project</Link></a>
  
  <a  class="nav-item nav-link active"><Link to="/addgroup">Add Group</Link></a>
  <a  class="nav-item nav-link active"><Link to="/addassaignproject">Add Assaign Project</Link></a>
